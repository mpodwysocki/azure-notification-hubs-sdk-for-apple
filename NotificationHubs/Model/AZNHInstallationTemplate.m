...
@implementation AZNHInstallationTemplate
...
- (BOOL)isEqual:(id)object {
    ...
    if (![(NSObject *)object isKindOfClass:[AZNHInstallationTemplate class]]) {
        return NO;
    }

    return [self isEqualToAZNHInstallationTemplate:(AZNHInstallationTemplate *)object];
}

- (BOOL)isEqualToAZNHInstallationTemplate:(AZNHInstallationTemplate *)template {
